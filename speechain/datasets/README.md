...
## Table of Contents
1. [**Configuration File Format**](https://github.com/bagustris/SpeeChain/tree/main/speechain/datasets#configuration-file-format)
2. [**Dataset Library**](https://github.com/bagustris/SpeeChain/tree/main/speechain/datasets#dataset-library)
3. [**API Document**](https://github.com/bagustris/SpeeChain/tree/main/speechain/datasets#api-document)
4. [**How to Mix Multiple Data Sources in my Dataset Object**](https://github.com/bagustris/SpeeChain/tree/main/speechain/datasets#how-to-mix-multiple-data-sources-in-my-dataset-object)
5. [**How to Perform Data Selection in my Dataset Object**](https://github.com/bagustris/SpeeChain/tree/main/speechain/datasets#how-to-perform-data-selection-in-my-dataset-object)
...
👆[Back to the table of contents](https://github.com/bagustris/SpeeChain/tree/main/speechain/datasets#table-of-contents)
...
## API Document
[**speechain.datasets.abs.Dataset**](https://github.com/bagustris/SpeeChain/tree/main/speechain/datasets#speechaindatasetsabsdataset)  

_Non-overridable backbone functions:_  
   1. [\_\_init__](https://github.com/bagustris/SpeeChain/tree/main/speechain/datasets#__init__self-main_data-data_selection-dataset_conf)  
   2. [\_\_getitem__](https://github.com/bagustris/SpeeChain/tree/main/speechain/datasets#__getitem__self-index)  
   3. [data_selection](https://github.com/bagustris/SpeeChain/tree/main/speechain/datasets#data_selectionself-selection_mode-selection_num-meta_info)  
   4. [get_data_index](https://github.com/bagustris/SpeeChain/tree/main/speechain/datasets#get_data_indexself)  
   5. [remove_data_by_index](https://github.com/bagustris/SpeeChain/tree/main/speechain/datasets#remove_data_by_indexself)  
   6. [collate_fn](https://github.com/bagustris/SpeeChain/tree/main/speechain/datasets#collate_fnself-batch)  
   
_Overridable interface functions:_  
   1. [dataset_init_fn](https://github.com/bagustris/SpeeChain/tree/main/speechain/datasets#dataset_init_fnself-dataset_conf)  
   2. [extract_main_data_fn](https://github.com/bagustris/SpeeChain/tree/main/speechain/datasets#extract_main_data_fnbatch_dict-main_data)  
   3. [collate_main_data_fn](https://github.com/bagustris/SpeeChain/tree/main/speechain/datasets#collate_main_data_fnself-batch_dict)  

👆[Back to the table of contents](https://github.com/bagustris/SpeeChain/tree/main/speechain/datasets#table-of-contents)

### speechain.datasets.abs.Dataset
...
👆[Back to the API list](https://github.com/bagustris/SpeeChain/tree/main/speechain/datasets#api-document)
