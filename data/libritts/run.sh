...
function print_help_message {
  ...
  $0 \\ (The arguments in [] are optional while other arguments must be given by your run.sh.)
      ...
      [--tgt_path TGT_PATH] \\                              # The metadata files will be generated to {tgt_path}/libritts. If tgt_path is not given, metadata files will be saved to ${SPEECHAIN_ROOT}/data/libritts. If you want to save metadata files elsewhere, please give its absolute path (starting by a slash '/') by this argument. (default: none)
